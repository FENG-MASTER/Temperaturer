package com.fengmaster.temperaturer.service;
...
public class BluetoothLeService extends Service {
	...
	public final static String ACTION_GATT_CONNECTED = "com.temper.bluetooth.le.ACTION_GATT_CONNECTED";
	public final static String ACTION_GATT_DISCONNECTED = "com.temper.bluetooth.le.ACTION_GATT_DISCONNECTED";
	public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.temper.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
	public final static String ACTION_DATA_AVAILABLE = "com.temper.bluetooth.le.ACTION_DATA_AVAILABLE";
	public final static String EXTRA_DATA = "com.temper.bluetooth.le.EXTRA_DATA";
...
//			System.out.println("++++++++++++++++"+new String(characteristic.getValue()));
	...
	{
        EventBus.getDefault().post(new BluetoothOriginalMessage(action,String.valueOf(rssi)));
	}

	private void broadcastUpdate(final String action)
	{
	    EventBus.getDefault().post(new BluetoothOriginalMessage(action));
	...
	{
        BluetoothOriginalMessage bluetoothOriginalMessage = new BluetoothOriginalMessage(action);
		//从特征值获取数据
		...
		if (data != null && data.length > 0)
		{
            ...
            bluetoothOriginalMessage.setData(new String(data));

			System.out.println("broadcastUpdate for  read data:"
					+ new String(data));
		}
		EventBus.getDefault().post(bluetoothOriginalMessage);
